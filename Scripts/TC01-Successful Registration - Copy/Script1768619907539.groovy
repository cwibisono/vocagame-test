...
WebUI.setText(findTestObject('Registration/Nama Depan'), 'Test')

WebUI.setText(findTestObject('Registration/Nama Belakang'), '123A')

WebUI.setText(findTestObject('Registration/input_email'), GlobalVariable.VALID_USERNAME)
...
WebUI.verifyElementPresent(findTestObject('Registration/li_User sudah terdaftar. Silahkan coba menggunakan email atau nomor handphone lain'), 
    0)
